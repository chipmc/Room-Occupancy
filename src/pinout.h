...
public:
    ...
    static const uint8_t Enable         = 6;         // This pin, when brought low, turns on the sensor
    static const uint8_t INT_PIN        = 7;         // This is the D7 pin which maps to the INT pin on the TOF Sensor
